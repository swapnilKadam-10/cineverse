...
export const Header = () => {
  ...
  const handleSubmit = (e) => {
    ...
    return navigate(`/search?q=${queryTerm}`); // navigate to search part.
  };
  return (
    <header className="fixed w-screen top-0">
      <nav className=" bg-white border-b-2  border-gray-200 px-2 sm:px-4 py-2 dark:border-0 dark:bg-gray-900">
